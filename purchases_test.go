...
func TestPurchases_Purchase_Encoding(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			v: Purchase{
				...
				Subscriptions: []NewSubscription{
					NewSubscription{PlanCode: "plan1"},
				},
		...
		{
			v:        Purchase{ShippingAddressID: 2438622711411416831},
...
func TestPurchases_Create(t *testing.T) {
	...
	r, invs, err := client.Purchases.Create(Purchase{})
	if err != nil {
...
func TestPurchases_Preview(t *testing.T) {
	...
	r, invs, err := client.Purchases.Preview(Purchase{})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	} else if r.IsError() {
